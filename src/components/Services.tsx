...
const services = [
    ...
    },
    {
        ...
        desc: "هل جربت كل شيء وما زلت تشعر بالخمول؟ نضبط هرموناتك بدقة متناهية لتعود لك حيويتك، وطاقتك المفقودة، ووزنك الطبيعي.",
        accentBg: "rgba(20,71,230,0.06)",
    },
    {
        icon: <FlaskConical className="w-6 h-6" style={{ color: "#1447E6" }} />,
        title: "إعادة التوازن الهرموني للجسم",
        desc: "الهرمونات هي المايسترو الذي يدير جسمك. نعالج تكيسات المبايض والخلل الهرموني بخبرة طبية تعيد لجسمك تناغمه الطبيعي.",
        accentBg: "rgba(20,71,230,0.06)",
    },
];
