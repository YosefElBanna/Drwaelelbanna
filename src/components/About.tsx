...
export default function About() {
    const features = [
        {
            title: "الاستماع لما وراء التحاليل",
            desc: "الأرقام في التحاليل لا تروي القصة كاملة. نربط بين أعراضك المشتتة، تاريخك العائلي، ونمط حياتك لنصل للسبب الجذري لمرضك قبل كتابة أي دواء."
        },
        {
