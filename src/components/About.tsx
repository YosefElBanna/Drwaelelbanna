...
export default function About() {
    const features = [
        {
            title: "التشخيص الدقيق لأصل المشكلة",
            desc: "لا نتعامل معك كمجرد أرقام في ورقة تحاليل، بل ندرس نمط حياتك ونربط بين أعراضك المتداخلة لنصل للسبب الجذري لمرضك قبل كتابة أي دواء."
        },
        {
